...
class FTPClient(QDialog):
    def __init__(self, parent=None, ftp_host="", ftp_user="anonymous", ftp_passwd="", ftp_port=21):
        ...
        self.ftp_port = ftp_port  # Porta do servidor FTP
    ...
    def load_ftp_directory(self):
        ...
        try:
            self.ftp.connect(self.ftp_host, self.ftp_port)  # Conecta ao servidor FTP na porta especificada
    ...
    def update_file_list(self):
        ...
        self.file_list.clear()  # Limpa a lista antes de adicionar novos itens
        files = []
    ...
    def download_file(self):
        ...
        if not selected_item.startswith('d'):  # Verifica se é um arquivo
            parts = selected_item.split()
            file_name = parts[-1]
...
class FTPBrowser(QMainWindow):
    def __init__(self):
        ...
        self.port_input.setPlaceholderText("Port (default: 21)")
    ...
    def add_new_tab(self, ftp_host, ftp_user, ftp_passwd, ftp_port):
        ...
        browser = FTPClient(self, ftp_host, ftp_user, ftp_passwd, ftp_port)
    ...
    def connect_to_ftp(self):
        ...
        ftp_port = int(self.port_input.text()) if self.port_input.text() else 21
    ...
    def show_connection_history(self):
        ...
        if history_manager.exec_() == QDialog.Accepted:
            selected_host, selected_user, selected_port = history_manager.get_selected_connection()
            self.host_input.setText(selected_host)
            self.user_input.setText(selected_user)
            self.port_input.setText(selected_port)
